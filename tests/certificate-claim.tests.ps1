...
Assert-Contains $html 'resource-card__icon' "Los recursos deben tener íconos visuales con acento."
...
Assert-Contains $styles '.resource-card__icon' "Faltan estilos para íconos de recursos."
