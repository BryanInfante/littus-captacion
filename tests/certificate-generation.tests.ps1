...
Assert-Contains $issueFunction 'qrCardSize: htmlMm(34)' "La tarjeta QR del PDF debe ser más grande y legible que la versión inicial."
Assert-Contains $issueFunction 'qrImageSize: htmlMm(23)' "El QR del PDF debe tener tamaño suficiente para escaneo e impresión."
